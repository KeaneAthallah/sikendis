<?php namespace App\Modules\Auth\User\Models;
/**
 * File			: UserModel.php
 * Description  : Model untuk halaman Auth > User
...
class UserModel extends Model {
    ...
    protected $allowedFields = ['user_name', 'password', 'nama_lengkap', 'keterangan', 'level_id', 'unit_id', 'is_active', 'is_login', 'last_login'];
    ...
    public function getDatatable($par=null) {
		...
		$datatables->select("a.id, a.user_name, a.nama_lengkap, a.keterangan, a.is_active, a.is_login,
							b.keterangan AS level,
					...
					->addColumn('actions', 
								'<td>
									<div class="d-flex align-items-center">
										...
										<button type="button" id="btn-delete" class="btn btn-sm btn-danger mb-0 py-1 px-2" data-mod="$1" data-id="$2" data-desc="$3" title="Hapus">
	...
	public function setLogin($id, $status) {
		$data['is_login'] = $status;
