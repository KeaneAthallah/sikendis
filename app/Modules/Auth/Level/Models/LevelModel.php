<?php namespace App\Modules\Auth\Level\Models;
/**
 * File			: LevelModel.php
 * Description  : Model untuk halaman Auth > Level
...
class LevelModel extends Model {
	...
	/* DIKOMEN DULU KARENA Titasictables BELUM DILOAD
	...
	*/
	...
	public function isUsed($id) {
		$jml = $this->builder()->selectCount('id')
			->join('user u', 'user_level.id = u.level_id', 'inner')
			->where('u.level_id', $id)
			->countAllResults(); 
