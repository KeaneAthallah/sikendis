<?php namespace App\Modules\Master\BahanBakar\Models;
/**
 * File			: BahanBakarModel.php
 * Description  : Model untuk halaman Master > Bahan Bakar
...
class BahanBakarModel extends Model {
	...
	public function isUsed($id) {
		$jml = $this->builder()->selectCount('id')
			->join('kendaraan k', 'bahan_bakar.id = k.bahan_bakar_id', 'inner')
			->where('k.bahan_bakar_id', $id)
			->countAllResults(); 
