<?php namespace App\Modules\Master\Kelompok\Models;
/**
 * File			: KelompokModel.php
 * Description  : Model untuk halaman Master > Kelompok
...
class KelompokModel extends Model {
	...
	public function isUsed($id) {
		$jml = $this->builder()->selectCount('id')
			->join('kendaraan k', 'kelompok.id = k.kelompok_id', 'inner')
			->where('k.kelompok_id', $id)
			->countAllResults(); 
