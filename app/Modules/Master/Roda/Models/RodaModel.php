<?php namespace App\Modules\Master\Roda\Models;
/**
 * File			: RodaModel.php
 * Description  : Model untuk halaman Master > Roda
...
class RodaModel extends Model {
	...
	public function isUsed($id) {
		$jml = $this->builder()->selectCount('id')
			->join('kendaraan k', 'roda.id = k.roda_id', 'inner')
			->where('k.roda_id', $id)
			->countAllResults(); 
