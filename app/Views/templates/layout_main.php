...
?>
<!DOCTYPE html>
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="../assets/" data-template="vertical-menu-template-free">
  <head>
    <meta charset="utf-8" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand">
            <a href="<?= base_url() ?>" class="app-brand-link">
              ...
              <span class="app-brand-text menu-text fw-bolder ms-2">SIKENDIS</span>
            </a>
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  ...
                  />
                  -->
                  <h3 class="text-primary mb-0 d-none d-md-block">Sistem Informasi Kendaraan Dinas</h3>
                  <h3 class="text-primary mb-0 d-block d-md-none">SIKENDIS</h3>
                </div>
              </div>
              <!-- /Search -->
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted"><?= session()->get('level_ket').' '.(session()->get('level_id') == 2 ? session()->get('nm_unit') : '') ?></small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="<?= site_url('auth/do-logout') ?>">
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  <a href="https://titasictech.com" target="_blank" class="footer-link fw-bolder">titasictech.com</a>
                </div>
                <div>
                  Template by <a href="https://themeselection.com" class="footer-link me-4" target="_blank">themeselection</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
